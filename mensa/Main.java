...
public class Main
{
  public static void main(String[] args) {
    MenuePlaner menueplaner1 = new MenuePlaner(getZutatenListe());
    menueplaner1.erstelleSpeiseplan();
    System.out.println(menueplaner1.getMenueFuerWochentag("Donnerstag"));
    System.out.println(menueplaner1.getMenueFuerWochentag("Mittwoch"));
  }
